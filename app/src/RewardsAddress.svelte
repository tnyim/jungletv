    ...
    <div class="md:col-span-1">
        <div class="px-4 sm:px-0">
            ...
            <p class="mt-1 text-sm text-gray-600">
                At the end of every video, the amount paid to enqueue the video is distributed evenly among eligible
                users.
            </p>
            <p class="mt-1 text-sm text-gray-600">
                Some videos have e.g. regional restrictions and may not display for you. You will still be
                rewarded as long as you keep the JungleTV page open throughout the duration of the video.
            </p>
                    ...
                    <div class="col-span-3">
                        ...
                        {:then}
                            ...
                            {:else if successful}
                                ...
                                {:else}
                                    <SuccessMessage>
                                        Successfully updated rewards address. If you are watching JungleTV in another
                                        window or tab, please refresh it to ensure you'll be rewarded.<br />
