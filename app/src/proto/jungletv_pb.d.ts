...
export class MediaConsumptionCheckpoint extends jspb.Message {
  ...
  getConfigurationChangesList(): Array<common_pb.ConfigurationChange>;
  setConfigurationChangesList(value: Array<common_pb.ConfigurationChange>): void;
  addConfigurationChanges(value?: common_pb.ConfigurationChange, index?: number): common_pb.ConfigurationChange;

  clearNotificationsList(): void;
  getNotificationsList(): Array<common_pb.Notification>;
  setNotificationsList(value: Array<common_pb.Notification>): void;
  addNotifications(value?: common_pb.Notification, index?: number): common_pb.Notification;
...
export namespace MediaConsumptionCheckpoint {
  export type AsObject = {
    ...
    mediaTitle: string,
    configurationChangesList: Array<common_pb.ConfigurationChange.AsObject>,
    notificationsList: Array<common_pb.Notification.AsObject>,
