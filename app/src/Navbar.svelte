...
<nav
    class="top-0 fixed z-50 h-16 w-full flex flex-wrap items-center justify-between px-2 py-3 navbar-expand-lg bg-white shadow"
>
    <div class="container max-w-none w-full px-4 mx-auto flex flex-wrap items-center justify-between">
        ...
        <div class="lg:flex flex-grow items-center {navbarOpen ? 'block' : 'hidden'}" id="example-navbar">
            <ul class="flex flex-col lg:flex-row list-none mr-auto">
                <li class="flex items-center">
                    {#if rAddress !== ""}
                        <span class="text-xs text-gray-500">
                            Rewarding <img src="https://monkey.banano.cc/api/v1/monkey/{rAddress}" alt="MonKey for the address" class="inline h-9 -mt-5 -mb-4 -ml-1 -mr-1"> <span class="font-mono">{rAddress}</span>
                        </span>
                    {/if}
                    {#if lastReward !== ""}
                        <span class="text-sm text-gray-700 bg-yellow-200 ml-5 p-1 rounded" in:fly={{ x: 200, duration: 1000 }} out:fade>
            ...
            <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
                ...
                <li class="flex items-center">
                    <a
                        ...
                        href="/rewards/address"
                    >
                        <i class="text-blueGray-400 fas fa-coins text-lg leading-lg mr-2" />
                        Earn rewards
                    </a>
                </li>
                ...
                <li class="flex items-center">
                    <a
                        class="bg-yellow-400 text-white active:bg-red-500 text-xs font-bold uppercase px-4 py-2 rounded shadow hover:shadow-lg outline-none focus:outline-none lg:mr-1 lg:mb-0 ml-3 mb-3 ease-linear transition-all duration-150"
                        use:link
                        href="/enqueue"
                    >
