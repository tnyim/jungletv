...
<div class="m-6 flex-grow container mx-auto max-w-screen-md p-2">
    ...
    <p class="mt-3">
        On JungleTV, users can earn Banano by watching YouTube videos that are added by other users to a sort of
        continuously evolving playlist - the <strong>queue</strong>. The videos play in sync for everyone, making the
    ...
    <div class="mt-5 flex justify-center">
        <a
            use:link
            href="/"
            class="justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-yellow-600 hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 shadow hover:shadow-lg ease-linear transition-all duration-150"
        >
            Watch JungleTV
        </a>
    </div>
