    ...
    <div class="px-4 py-5 bg-white dark:bg-gray-800 space-y-6 sm:p-6">
        <div class="grid grid-cols-3 gap-6">
            <div class="col-span-3">
                <p>
                    <span class="text-lg">Earn prizes for enqueuing media!</span>
                ...
                {#if ongoingRaffleInfo.hasUserTickets()}
                    <p class="text-sm">
                        ...
                        {:else}
                            You do not have any tickets in the ongoing raffle; enqueue a video or track to get a chance
                            to win a prize! You'll get the corresponding raffle ticket once it begins playing.
                        {/if}
                    </p>
                {/if}
