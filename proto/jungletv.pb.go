...
var file_jungletv_proto_rawDesc = []byte{
	...
	0x66, 0x57, 0x6f, 0x72, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2a, 0x3d, 0x0a,
	...
	0x42, 0x4c, 0x45, 0x44, 0x10, 0x02, 0x32, 0xcc, 0x0b, 0x0a, 0x08, 0x4a, 0x75, 0x6e, 0x67, 0x6c,
...
var file_jungletv_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_jungletv_proto_msgTypes = make([]protoimpl.MessageInfo, 55)
var file_jungletv_proto_goTypes = []interface{}{
	...
	(*SignInRequest)(nil),                    // 5: jungletv.SignInRequest
	(*SignInProgress)(nil),                   // 6: jungletv.SignInProgress
	(*SignInVerification)(nil),               // 7: jungletv.SignInVerification
	(*SignInAccountUnopened)(nil),            // 8: jungletv.SignInAccountUnopened
	(*SignInResponse)(nil),                   // 9: jungletv.SignInResponse
	(*SignInVerificationExpired)(nil),        // 10: jungletv.SignInVerificationExpired
	(*EnqueueYouTubeVideoData)(nil),          // 11: jungletv.EnqueueYouTubeVideoData
	(*EnqueueStubData)(nil),                  // 12: jungletv.EnqueueStubData
	(*EnqueueMediaRequest)(nil),              // 13: jungletv.EnqueueMediaRequest
	(*EnqueueMediaResponse)(nil),             // 14: jungletv.EnqueueMediaResponse
	(*EnqueueMediaFailure)(nil),              // 15: jungletv.EnqueueMediaFailure
	(*EnqueueMediaTicket)(nil),               // 16: jungletv.EnqueueMediaTicket
	(*MonitorTicketRequest)(nil),             // 17: jungletv.MonitorTicketRequest
	(*ConsumeMediaRequest)(nil),              // 18: jungletv.ConsumeMediaRequest
	(*NowPlayingStubData)(nil),               // 19: jungletv.NowPlayingStubData
	(*NowPlayingYouTubeVideoData)(nil),       // 20: jungletv.NowPlayingYouTubeVideoData
	(*MediaConsumptionCheckpoint)(nil),       // 21: jungletv.MediaConsumptionCheckpoint
	(*ProofOfWorkTask)(nil),                  // 22: jungletv.ProofOfWorkTask
	(*MonitorQueueRequest)(nil),              // 23: jungletv.MonitorQueueRequest
	(*Queue)(nil),                            // 24: jungletv.Queue
	(*QueueYouTubeVideoData)(nil),            // 25: jungletv.QueueYouTubeVideoData
	(*QueueEntry)(nil),                       // 26: jungletv.QueueEntry
	(*User)(nil),                             // 27: jungletv.User
	(*RewardInfoRequest)(nil),                // 28: jungletv.RewardInfoRequest
	(*RewardInfoResponse)(nil),               // 29: jungletv.RewardInfoResponse
	(*RemoveQueueEntryRequest)(nil),          // 30: jungletv.RemoveQueueEntryRequest
	(*RemoveQueueEntryResponse)(nil),         // 31: jungletv.RemoveQueueEntryResponse
	(*ForciblyEnqueueTicketRequest)(nil),     // 32: jungletv.ForciblyEnqueueTicketRequest
	(*ForciblyEnqueueTicketResponse)(nil),    // 33: jungletv.ForciblyEnqueueTicketResponse
	(*SubmitActivityChallengeRequest)(nil),   // 34: jungletv.SubmitActivityChallengeRequest
	(*SubmitActivityChallengeResponse)(nil),  // 35: jungletv.SubmitActivityChallengeResponse
	(*ConsumeChatRequest)(nil),               // 36: jungletv.ConsumeChatRequest
	(*ChatUpdate)(nil),                       // 37: jungletv.ChatUpdate
	(*ChatMessage)(nil),                      // 38: jungletv.ChatMessage
	(*UserChatMessage)(nil),                  // 39: jungletv.UserChatMessage
	(*SystemChatMessage)(nil),                // 40: jungletv.SystemChatMessage
	(*ChatDisabledEvent)(nil),                // 41: jungletv.ChatDisabledEvent
	(*ChatEnabledEvent)(nil),                 // 42: jungletv.ChatEnabledEvent
	(*ChatMessageCreatedEvent)(nil),          // 43: jungletv.ChatMessageCreatedEvent
	(*ChatMessageDeletedEvent)(nil),          // 44: jungletv.ChatMessageDeletedEvent
	(*ChatHeartbeatEvent)(nil),               // 45: jungletv.ChatHeartbeatEvent
	(*SendChatMessageRequest)(nil),           // 46: jungletv.SendChatMessageRequest
	(*SendChatMessageResponse)(nil),          // 47: jungletv.SendChatMessageResponse
	(*RemoveChatMessageRequest)(nil),         // 48: jungletv.RemoveChatMessageRequest
	(*RemoveChatMessageResponse)(nil),        // 49: jungletv.RemoveChatMessageResponse
	(*SetChatSettingsRequest)(nil),           // 50: jungletv.SetChatSettingsRequest
	(*SetChatSettingsResponse)(nil),          // 51: jungletv.SetChatSettingsResponse
	(*BanUserRequest)(nil),                   // 52: jungletv.BanUserRequest
	(*BanUserResponse)(nil),                  // 53: jungletv.BanUserResponse
	(*RemoveBanRequest)(nil),                 // 54: jungletv.RemoveBanRequest
	(*RemoveBanResponse)(nil),                // 55: jungletv.RemoveBanResponse
	(*SetVideoEnqueuingEnabledRequest)(nil),  // 56: jungletv.SetVideoEnqueuingEnabledRequest
	(*SetVideoEnqueuingEnabledResponse)(nil), // 57: jungletv.SetVideoEnqueuingEnabledResponse
	(*SubmitProofOfWorkRequest)(nil),         // 58: jungletv.SubmitProofOfWorkRequest
	(*SubmitProofOfWorkResponse)(nil),        // 59: jungletv.SubmitProofOfWorkResponse
	(*timestamppb.Timestamp)(nil),            // 60: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),              // 61: google.protobuf.Duration
}
var file_jungletv_proto_depIdxs = []int32{
	7,  // 0: jungletv.SignInProgress.verification:type_name -> jungletv.SignInVerification
	9,  // 1: jungletv.SignInProgress.response:type_name -> jungletv.SignInResponse
	10, // 2: jungletv.SignInProgress.expired:type_name -> jungletv.SignInVerificationExpired
	8,  // 3: jungletv.SignInProgress.account_unopened:type_name -> jungletv.SignInAccountUnopened
	60, // 4: jungletv.SignInVerification.expiration:type_name -> google.protobuf.Timestamp
	60, // 5: jungletv.SignInResponse.token_expiration:type_name -> google.protobuf.Timestamp
	12, // 6: jungletv.EnqueueMediaRequest.stub_data:type_name -> jungletv.EnqueueStubData
	11, // 7: jungletv.EnqueueMediaRequest.youtube_video_data:type_name -> jungletv.EnqueueYouTubeVideoData
	16, // 8: jungletv.EnqueueMediaResponse.ticket:type_name -> jungletv.EnqueueMediaTicket
	15, // 9: jungletv.EnqueueMediaResponse.failure:type_name -> jungletv.EnqueueMediaFailure
	0,  // 10: jungletv.EnqueueMediaTicket.status:type_name -> jungletv.EnqueueMediaTicketStatus
	60, // 11: jungletv.EnqueueMediaTicket.expiration:type_name -> google.protobuf.Timestamp
	25, // 12: jungletv.EnqueueMediaTicket.youtube_video_data:type_name -> jungletv.QueueYouTubeVideoData
	61, // 13: jungletv.MediaConsumptionCheckpoint.current_position:type_name -> google.protobuf.Duration
	27, // 14: jungletv.MediaConsumptionCheckpoint.requested_by:type_name -> jungletv.User
	22, // 15: jungletv.MediaConsumptionCheckpoint.pow_task:type_name -> jungletv.ProofOfWorkTask
	19, // 16: jungletv.MediaConsumptionCheckpoint.stub_data:type_name -> jungletv.NowPlayingStubData
	20, // 17: jungletv.MediaConsumptionCheckpoint.youtube_video_data:type_name -> jungletv.NowPlayingYouTubeVideoData
	26, // 18: jungletv.Queue.entries:type_name -> jungletv.QueueEntry
	27, // 19: jungletv.QueueEntry.requested_by:type_name -> jungletv.User
	61, // 20: jungletv.QueueEntry.length:type_name -> google.protobuf.Duration
	25, // 21: jungletv.QueueEntry.youtube_video_data:type_name -> jungletv.QueueYouTubeVideoData
	...
	41, // 24: jungletv.ChatUpdate.disabled:type_name -> jungletv.ChatDisabledEvent
	42, // 25: jungletv.ChatUpdate.enabled:type_name -> jungletv.ChatEnabledEvent
	43, // 26: jungletv.ChatUpdate.message_created:type_name -> jungletv.ChatMessageCreatedEvent
	44, // 27: jungletv.ChatUpdate.message_deleted:type_name -> jungletv.ChatMessageDeletedEvent
	45, // 28: jungletv.ChatUpdate.heartbeat:type_name -> jungletv.ChatHeartbeatEvent
	60, // 29: jungletv.ChatMessage.created_at:type_name -> google.protobuf.Timestamp
	39, // 30: jungletv.ChatMessage.user_message:type_name -> jungletv.UserChatMessage
	40, // 31: jungletv.ChatMessage.system_message:type_name -> jungletv.SystemChatMessage
	38, // 32: jungletv.ChatMessage.reference:type_name -> jungletv.ChatMessage
	27, // 33: jungletv.UserChatMessage.author:type_name -> jungletv.User
	3,  // 34: jungletv.ChatDisabledEvent.reason:type_name -> jungletv.ChatDisabledReason
	38, // 35: jungletv.ChatMessageCreatedEvent.message:type_name -> jungletv.ChatMessage
	4,  // 36: jungletv.SetVideoEnqueuingEnabledRequest.allowed:type_name -> jungletv.AllowedVideoEnqueuingType
	5,  // 37: jungletv.JungleTV.SignIn:input_type -> jungletv.SignInRequest
	13, // 38: jungletv.JungleTV.EnqueueMedia:input_type -> jungletv.EnqueueMediaRequest
	17, // 39: jungletv.JungleTV.MonitorTicket:input_type -> jungletv.MonitorTicketRequest
	18, // 40: jungletv.JungleTV.ConsumeMedia:input_type -> jungletv.ConsumeMediaRequest
	23, // 41: jungletv.JungleTV.MonitorQueue:input_type -> jungletv.MonitorQueueRequest
	28, // 42: jungletv.JungleTV.RewardInfo:input_type -> jungletv.RewardInfoRequest
	34, // 43: jungletv.JungleTV.SubmitActivityChallenge:input_type -> jungletv.SubmitActivityChallengeRequest
	36, // 44: jungletv.JungleTV.ConsumeChat:input_type -> jungletv.ConsumeChatRequest
	46, // 45: jungletv.JungleTV.SendChatMessage:input_type -> jungletv.SendChatMessageRequest
	58, // 46: jungletv.JungleTV.SubmitProofOfWork:input_type -> jungletv.SubmitProofOfWorkRequest
	32, // 47: jungletv.JungleTV.ForciblyEnqueueTicket:input_type -> jungletv.ForciblyEnqueueTicketRequest
	30, // 48: jungletv.JungleTV.RemoveQueueEntry:input_type -> jungletv.RemoveQueueEntryRequest
	48, // 49: jungletv.JungleTV.RemoveChatMessage:input_type -> jungletv.RemoveChatMessageRequest
	50, // 50: jungletv.JungleTV.SetChatSettings:input_type -> jungletv.SetChatSettingsRequest
	56, // 51: jungletv.JungleTV.SetVideoEnqueuingEnabled:input_type -> jungletv.SetVideoEnqueuingEnabledRequest
	52, // 52: jungletv.JungleTV.BanUser:input_type -> jungletv.BanUserRequest
	54, // 53: jungletv.JungleTV.RemoveBan:input_type -> jungletv.RemoveBanRequest
	6,  // 54: jungletv.JungleTV.SignIn:output_type -> jungletv.SignInProgress
	14, // 55: jungletv.JungleTV.EnqueueMedia:output_type -> jungletv.EnqueueMediaResponse
	16, // 56: jungletv.JungleTV.MonitorTicket:output_type -> jungletv.EnqueueMediaTicket
	21, // 57: jungletv.JungleTV.ConsumeMedia:output_type -> jungletv.MediaConsumptionCheckpoint
	24, // 58: jungletv.JungleTV.MonitorQueue:output_type -> jungletv.Queue
	29, // 59: jungletv.JungleTV.RewardInfo:output_type -> jungletv.RewardInfoResponse
	35, // 60: jungletv.JungleTV.SubmitActivityChallenge:output_type -> jungletv.SubmitActivityChallengeResponse
	37, // 61: jungletv.JungleTV.ConsumeChat:output_type -> jungletv.ChatUpdate
	47, // 62: jungletv.JungleTV.SendChatMessage:output_type -> jungletv.SendChatMessageResponse
	59, // 63: jungletv.JungleTV.SubmitProofOfWork:output_type -> jungletv.SubmitProofOfWorkResponse
	33, // 64: jungletv.JungleTV.ForciblyEnqueueTicket:output_type -> jungletv.ForciblyEnqueueTicketResponse
	31, // 65: jungletv.JungleTV.RemoveQueueEntry:output_type -> jungletv.RemoveQueueEntryResponse
	49, // 66: jungletv.JungleTV.RemoveChatMessage:output_type -> jungletv.RemoveChatMessageResponse
	51, // 67: jungletv.JungleTV.SetChatSettings:output_type -> jungletv.SetChatSettingsResponse
	57, // 68: jungletv.JungleTV.SetVideoEnqueuingEnabled:output_type -> jungletv.SetVideoEnqueuingEnabledResponse
	53, // 69: jungletv.JungleTV.BanUser:output_type -> jungletv.BanUserResponse
	55, // 70: jungletv.JungleTV.RemoveBan:output_type -> jungletv.RemoveBanResponse
