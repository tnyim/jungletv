...
var file_jungletv_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x73, 0x2a, 0x3d, 0x0a, 0x18, 0x45, 0x6e, 0x71, 0x75, 0x65, 0x75, 0x65, 0x4d, 0x65,
	...
	0x09, 0x0a, 0x05, 0x41, 0x44, 0x4d, 0x49, 0x4e, 0x10, 0x02, 0x32, 0xe8, 0x1b, 0x0a, 0x08, 0x4a,
...
var file_jungletv_proto_depIdxs = []int32{
	...
	114, // 43: jungletv.DisallowedVideo.disallowed_at:type_name -> google.protobuf.Timestamp
	...
	114, // 49: jungletv.ReceivedReward.received_at:type_name -> google.protobuf.Timestamp
	...
	114, // 53: jungletv.Withdrawal.started_at:type_name -> google.protobuf.Timestamp
	114, // 54: jungletv.Withdrawal.completed_at:type_name -> google.protobuf.Timestamp
	...
	113, // 57: jungletv.OngoingRaffleInfoResponse.raffle_info:type_name -> jungletv.OngoingRaffleInfo
	114, // 58: jungletv.OngoingRaffleInfo.period_start:type_name -> google.protobuf.Timestamp
	114, // 59: jungletv.OngoingRaffleInfo.period_end:type_name -> google.protobuf.Timestamp
	8,   // 60: jungletv.JungleTV.SignIn:input_type -> jungletv.SignInRequest
	16,  // 61: jungletv.JungleTV.EnqueueMedia:input_type -> jungletv.EnqueueMediaRequest
	21,  // 62: jungletv.JungleTV.RemoveOwnQueueEntry:input_type -> jungletv.RemoveOwnQueueEntryRequest
	20,  // 63: jungletv.JungleTV.MonitorTicket:input_type -> jungletv.MonitorTicketRequest
	23,  // 64: jungletv.JungleTV.ConsumeMedia:input_type -> jungletv.ConsumeMediaRequest
	28,  // 65: jungletv.JungleTV.MonitorQueue:input_type -> jungletv.MonitorQueueRequest
	32,  // 66: jungletv.JungleTV.MonitorSkipAndTip:input_type -> jungletv.MonitorSkipAndTipRequest
	35,  // 67: jungletv.JungleTV.RewardInfo:input_type -> jungletv.RewardInfoRequest
	41,  // 68: jungletv.JungleTV.SubmitActivityChallenge:input_type -> jungletv.SubmitActivityChallengeRequest
	102, // 69: jungletv.JungleTV.ProduceSegchaChallenge:input_type -> jungletv.ProduceSegchaChallengeRequest
	43,  // 70: jungletv.JungleTV.ConsumeChat:input_type -> jungletv.ConsumeChatRequest
	53,  // 71: jungletv.JungleTV.SendChatMessage:input_type -> jungletv.SendChatMessageRequest
	67,  // 72: jungletv.JungleTV.UserPermissionLevel:input_type -> jungletv.UserPermissionLevelRequest
	76,  // 73: jungletv.JungleTV.GetDocument:input_type -> jungletv.GetDocumentRequest
	79,  // 74: jungletv.JungleTV.SetChatNickname:input_type -> jungletv.SetChatNicknameRequest
	85,  // 75: jungletv.JungleTV.Withdraw:input_type -> jungletv.WithdrawRequest
	87,  // 76: jungletv.JungleTV.Leaderboards:input_type -> jungletv.LeaderboardsRequest
	92,  // 77: jungletv.JungleTV.RewardHistory:input_type -> jungletv.RewardHistoryRequest
	95,  // 78: jungletv.JungleTV.WithdrawalHistory:input_type -> jungletv.WithdrawalHistoryRequest
	111, // 79: jungletv.JungleTV.OngoingRaffleInfo:input_type -> jungletv.OngoingRaffleInfoRequest
	39,  // 80: jungletv.JungleTV.ForciblyEnqueueTicket:input_type -> jungletv.ForciblyEnqueueTicketRequest
	37,  // 81: jungletv.JungleTV.RemoveQueueEntry:input_type -> jungletv.RemoveQueueEntryRequest
	55,  // 82: jungletv.JungleTV.RemoveChatMessage:input_type -> jungletv.RemoveChatMessageRequest
	57,  // 83: jungletv.JungleTV.SetChatSettings:input_type -> jungletv.SetChatSettingsRequest
	63,  // 84: jungletv.JungleTV.SetVideoEnqueuingEnabled:input_type -> jungletv.SetVideoEnqueuingEnabledRequest
	59,  // 85: jungletv.JungleTV.BanUser:input_type -> jungletv.BanUserRequest
	61,  // 86: jungletv.JungleTV.RemoveBan:input_type -> jungletv.RemoveBanRequest
	65,  // 87: jungletv.JungleTV.UserChatMessages:input_type -> jungletv.UserChatMessagesRequest
	69,  // 88: jungletv.JungleTV.DisallowedVideos:input_type -> jungletv.DisallowedVideosRequest
	72,  // 89: jungletv.JungleTV.AddDisallowedVideo:input_type -> jungletv.AddDisallowedVideoRequest
	74,  // 90: jungletv.JungleTV.RemoveDisallowedVideo:input_type -> jungletv.RemoveDisallowedVideoRequest
	77,  // 91: jungletv.JungleTV.UpdateDocument:input_type -> jungletv.Document
	81,  // 92: jungletv.JungleTV.SetUserChatNickname:input_type -> jungletv.SetUserChatNicknameRequest
	83,  // 93: jungletv.JungleTV.SetPricesMultiplier:input_type -> jungletv.SetPricesMultiplierRequest
	98,  // 94: jungletv.JungleTV.SetCrowdfundedSkippingEnabled:input_type -> jungletv.SetCrowdfundedSkippingEnabledRequest
	100, // 95: jungletv.JungleTV.SetSkipPriceMultiplier:input_type -> jungletv.SetSkipPriceMultiplierRequest
	105, // 96: jungletv.JungleTV.ConfirmRaffleWinner:input_type -> jungletv.ConfirmRaffleWinnerRequest
	107, // 97: jungletv.JungleTV.CompleteRaffle:input_type -> jungletv.CompleteRaffleRequest
	109, // 98: jungletv.JungleTV.RedrawRaffle:input_type -> jungletv.RedrawRaffleRequest
	9,   // 99: jungletv.JungleTV.SignIn:output_type -> jungletv.SignInProgress
	17,  // 100: jungletv.JungleTV.EnqueueMedia:output_type -> jungletv.EnqueueMediaResponse
	22,  // 101: jungletv.JungleTV.RemoveOwnQueueEntry:output_type -> jungletv.RemoveOwnQueueEntryResponse
	19,  // 102: jungletv.JungleTV.MonitorTicket:output_type -> jungletv.EnqueueMediaTicket
	26,  // 103: jungletv.JungleTV.ConsumeMedia:output_type -> jungletv.MediaConsumptionCheckpoint
	29,  // 104: jungletv.JungleTV.MonitorQueue:output_type -> jungletv.Queue
	33,  // 105: jungletv.JungleTV.MonitorSkipAndTip:output_type -> jungletv.SkipAndTipStatus
	36,  // 106: jungletv.JungleTV.RewardInfo:output_type -> jungletv.RewardInfoResponse
	42,  // 107: jungletv.JungleTV.SubmitActivityChallenge:output_type -> jungletv.SubmitActivityChallengeResponse
	103, // 108: jungletv.JungleTV.ProduceSegchaChallenge:output_type -> jungletv.ProduceSegchaChallengeResponse
	44,  // 109: jungletv.JungleTV.ConsumeChat:output_type -> jungletv.ChatUpdate
	54,  // 110: jungletv.JungleTV.SendChatMessage:output_type -> jungletv.SendChatMessageResponse
	68,  // 111: jungletv.JungleTV.UserPermissionLevel:output_type -> jungletv.UserPermissionLevelResponse
	77,  // 112: jungletv.JungleTV.GetDocument:output_type -> jungletv.Document
	80,  // 113: jungletv.JungleTV.SetChatNickname:output_type -> jungletv.SetChatNicknameResponse
	86,  // 114: jungletv.JungleTV.Withdraw:output_type -> jungletv.WithdrawResponse
	88,  // 115: jungletv.JungleTV.Leaderboards:output_type -> jungletv.LeaderboardsResponse
	94,  // 116: jungletv.JungleTV.RewardHistory:output_type -> jungletv.RewardHistoryResponse
	97,  // 117: jungletv.JungleTV.WithdrawalHistory:output_type -> jungletv.WithdrawalHistoryResponse
	112, // 118: jungletv.JungleTV.OngoingRaffleInfo:output_type -> jungletv.OngoingRaffleInfoResponse
	40,  // 119: jungletv.JungleTV.ForciblyEnqueueTicket:output_type -> jungletv.ForciblyEnqueueTicketResponse
	38,  // 120: jungletv.JungleTV.RemoveQueueEntry:output_type -> jungletv.RemoveQueueEntryResponse
	56,  // 121: jungletv.JungleTV.RemoveChatMessage:output_type -> jungletv.RemoveChatMessageResponse
	58,  // 122: jungletv.JungleTV.SetChatSettings:output_type -> jungletv.SetChatSettingsResponse
	64,  // 123: jungletv.JungleTV.SetVideoEnqueuingEnabled:output_type -> jungletv.SetVideoEnqueuingEnabledResponse
	60,  // 124: jungletv.JungleTV.BanUser:output_type -> jungletv.BanUserResponse
	62,  // 125: jungletv.JungleTV.RemoveBan:output_type -> jungletv.RemoveBanResponse
	66,  // 126: jungletv.JungleTV.UserChatMessages:output_type -> jungletv.UserChatMessagesResponse
	71,  // 127: jungletv.JungleTV.DisallowedVideos:output_type -> jungletv.DisallowedVideosResponse
	73,  // 128: jungletv.JungleTV.AddDisallowedVideo:output_type -> jungletv.AddDisallowedVideoResponse
	75,  // 129: jungletv.JungleTV.RemoveDisallowedVideo:output_type -> jungletv.RemoveDisallowedVideoResponse
	78,  // 130: jungletv.JungleTV.UpdateDocument:output_type -> jungletv.UpdateDocumentResponse
	82,  // 131: jungletv.JungleTV.SetUserChatNickname:output_type -> jungletv.SetUserChatNicknameResponse
	84,  // 132: jungletv.JungleTV.SetPricesMultiplier:output_type -> jungletv.SetPricesMultiplierResponse
	99,  // 133: jungletv.JungleTV.SetCrowdfundedSkippingEnabled:output_type -> jungletv.SetCrowdfundedSkippingEnabledResponse
	101, // 134: jungletv.JungleTV.SetSkipPriceMultiplier:output_type -> jungletv.SetSkipPriceMultiplierResponse
	106, // 135: jungletv.JungleTV.ConfirmRaffleWinner:output_type -> jungletv.ConfirmRaffleWinnerResponse
	108, // 136: jungletv.JungleTV.CompleteRaffle:output_type -> jungletv.CompleteRaffleResponse
	110, // 137: jungletv.JungleTV.RedrawRaffle:output_type -> jungletv.RedrawRaffleResponse
