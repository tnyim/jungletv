...
var file_jungletv_proto_rawDesc = []byte{
	...
	0x45, 0x4e, 0x54, 0x10, 0x01, 0x32, 0xed, 0x08, 0x0a, 0x08, 0x4a, 0x75, 0x6e, 0x67, 0x6c, 0x65,
...
var file_jungletv_proto_msgTypes = make([]protoimpl.MessageInfo, 46)
var file_jungletv_proto_goTypes = []interface{}{
	...
	(*SignInAccountUnopened)(nil),           // 7: jungletv.SignInAccountUnopened
	(*SignInResponse)(nil),                  // 8: jungletv.SignInResponse
	(*SignInVerificationExpired)(nil),       // 9: jungletv.SignInVerificationExpired
	(*EnqueueYouTubeVideoData)(nil),         // 10: jungletv.EnqueueYouTubeVideoData
	(*EnqueueStubData)(nil),                 // 11: jungletv.EnqueueStubData
	(*EnqueueMediaRequest)(nil),             // 12: jungletv.EnqueueMediaRequest
	(*EnqueueMediaResponse)(nil),            // 13: jungletv.EnqueueMediaResponse
	(*EnqueueMediaFailure)(nil),             // 14: jungletv.EnqueueMediaFailure
	(*EnqueueMediaTicket)(nil),              // 15: jungletv.EnqueueMediaTicket
	(*MonitorTicketRequest)(nil),            // 16: jungletv.MonitorTicketRequest
	(*ConsumeMediaRequest)(nil),             // 17: jungletv.ConsumeMediaRequest
	(*NowPlayingStubData)(nil),              // 18: jungletv.NowPlayingStubData
	(*NowPlayingYouTubeVideoData)(nil),      // 19: jungletv.NowPlayingYouTubeVideoData
	(*MediaConsumptionCheckpoint)(nil),      // 20: jungletv.MediaConsumptionCheckpoint
	(*MonitorQueueRequest)(nil),             // 21: jungletv.MonitorQueueRequest
	(*Queue)(nil),                           // 22: jungletv.Queue
	(*QueueYouTubeVideoData)(nil),           // 23: jungletv.QueueYouTubeVideoData
	(*QueueEntry)(nil),                      // 24: jungletv.QueueEntry
	(*User)(nil),                            // 25: jungletv.User
	(*RewardInfoRequest)(nil),               // 26: jungletv.RewardInfoRequest
	(*RewardInfoResponse)(nil),              // 27: jungletv.RewardInfoResponse
	(*RemoveQueueEntryRequest)(nil),         // 28: jungletv.RemoveQueueEntryRequest
	(*RemoveQueueEntryResponse)(nil),        // 29: jungletv.RemoveQueueEntryResponse
	(*ForciblyEnqueueTicketRequest)(nil),    // 30: jungletv.ForciblyEnqueueTicketRequest
	(*ForciblyEnqueueTicketResponse)(nil),   // 31: jungletv.ForciblyEnqueueTicketResponse
	(*SubmitActivityChallengeRequest)(nil),  // 32: jungletv.SubmitActivityChallengeRequest
	(*SubmitActivityChallengeResponse)(nil), // 33: jungletv.SubmitActivityChallengeResponse
	(*ConsumeChatRequest)(nil),              // 34: jungletv.ConsumeChatRequest
	(*ChatUpdate)(nil),                      // 35: jungletv.ChatUpdate
	(*ChatMessage)(nil),                     // 36: jungletv.ChatMessage
	(*UserChatMessage)(nil),                 // 37: jungletv.UserChatMessage
	(*SystemChatMessage)(nil),               // 38: jungletv.SystemChatMessage
	(*ChatDisabledEvent)(nil),               // 39: jungletv.ChatDisabledEvent
	(*ChatEnabledEvent)(nil),                // 40: jungletv.ChatEnabledEvent
	(*ChatMessageCreatedEvent)(nil),         // 41: jungletv.ChatMessageCreatedEvent
	(*ChatMessageDeletedEvent)(nil),         // 42: jungletv.ChatMessageDeletedEvent
	(*ChatHeartbeatEvent)(nil),              // 43: jungletv.ChatHeartbeatEvent
	(*SendChatMessageRequest)(nil),          // 44: jungletv.SendChatMessageRequest
	(*SendChatMessageResponse)(nil),         // 45: jungletv.SendChatMessageResponse
	(*RemoveChatMessageRequest)(nil),        // 46: jungletv.RemoveChatMessageRequest
	(*RemoveChatMessageResponse)(nil),       // 47: jungletv.RemoveChatMessageResponse
	(*SetChatSettingsRequest)(nil),          // 48: jungletv.SetChatSettingsRequest
	(*SetChatSettingsResponse)(nil),         // 49: jungletv.SetChatSettingsResponse
...
var file_jungletv_proto_depIdxs = []int32{
	...
	8,  // 1: jungletv.SignInProgress.response:type_name -> jungletv.SignInResponse
	9,  // 2: jungletv.SignInProgress.expired:type_name -> jungletv.SignInVerificationExpired
	7,  // 3: jungletv.SignInProgress.account_unopened:type_name -> jungletv.SignInAccountUnopened
	50, // 4: jungletv.SignInVerification.expiration:type_name -> google.protobuf.Timestamp
	50, // 5: jungletv.SignInResponse.token_expiration:type_name -> google.protobuf.Timestamp
	11, // 6: jungletv.EnqueueMediaRequest.stub_data:type_name -> jungletv.EnqueueStubData
	10, // 7: jungletv.EnqueueMediaRequest.youtube_video_data:type_name -> jungletv.EnqueueYouTubeVideoData
	15, // 8: jungletv.EnqueueMediaResponse.ticket:type_name -> jungletv.EnqueueMediaTicket
	14, // 9: jungletv.EnqueueMediaResponse.failure:type_name -> jungletv.EnqueueMediaFailure
	0,  // 10: jungletv.EnqueueMediaTicket.status:type_name -> jungletv.EnqueueMediaTicketStatus
	50, // 11: jungletv.EnqueueMediaTicket.expiration:type_name -> google.protobuf.Timestamp
	23, // 12: jungletv.EnqueueMediaTicket.youtube_video_data:type_name -> jungletv.QueueYouTubeVideoData
	51, // 13: jungletv.MediaConsumptionCheckpoint.current_position:type_name -> google.protobuf.Duration
	25, // 14: jungletv.MediaConsumptionCheckpoint.requested_by:type_name -> jungletv.User
	18, // 15: jungletv.MediaConsumptionCheckpoint.stub_data:type_name -> jungletv.NowPlayingStubData
	19, // 16: jungletv.MediaConsumptionCheckpoint.youtube_video_data:type_name -> jungletv.NowPlayingYouTubeVideoData
	24, // 17: jungletv.Queue.entries:type_name -> jungletv.QueueEntry
	25, // 18: jungletv.QueueEntry.requested_by:type_name -> jungletv.User
	51, // 19: jungletv.QueueEntry.length:type_name -> google.protobuf.Duration
	23, // 20: jungletv.QueueEntry.youtube_video_data:type_name -> jungletv.QueueYouTubeVideoData
	...
	39, // 23: jungletv.ChatUpdate.disabled:type_name -> jungletv.ChatDisabledEvent
	40, // 24: jungletv.ChatUpdate.enabled:type_name -> jungletv.ChatEnabledEvent
	41, // 25: jungletv.ChatUpdate.message_created:type_name -> jungletv.ChatMessageCreatedEvent
	42, // 26: jungletv.ChatUpdate.message_deleted:type_name -> jungletv.ChatMessageDeletedEvent
	43, // 27: jungletv.ChatUpdate.heartbeat:type_name -> jungletv.ChatHeartbeatEvent
	50, // 28: jungletv.ChatMessage.created_at:type_name -> google.protobuf.Timestamp
	37, // 29: jungletv.ChatMessage.user_message:type_name -> jungletv.UserChatMessage
	38, // 30: jungletv.ChatMessage.system_message:type_name -> jungletv.SystemChatMessage
	36, // 31: jungletv.ChatMessage.reference:type_name -> jungletv.ChatMessage
	25, // 32: jungletv.UserChatMessage.author:type_name -> jungletv.User
	3,  // 33: jungletv.ChatDisabledEvent.reason:type_name -> jungletv.ChatDisabledReason
	36, // 34: jungletv.ChatMessageCreatedEvent.message:type_name -> jungletv.ChatMessage
	4,  // 35: jungletv.JungleTV.SignIn:input_type -> jungletv.SignInRequest
	12, // 36: jungletv.JungleTV.EnqueueMedia:input_type -> jungletv.EnqueueMediaRequest
	16, // 37: jungletv.JungleTV.MonitorTicket:input_type -> jungletv.MonitorTicketRequest
	17, // 38: jungletv.JungleTV.ConsumeMedia:input_type -> jungletv.ConsumeMediaRequest
	21, // 39: jungletv.JungleTV.MonitorQueue:input_type -> jungletv.MonitorQueueRequest
	26, // 40: jungletv.JungleTV.RewardInfo:input_type -> jungletv.RewardInfoRequest
	32, // 41: jungletv.JungleTV.SubmitActivityChallenge:input_type -> jungletv.SubmitActivityChallengeRequest
	34, // 42: jungletv.JungleTV.ConsumeChat:input_type -> jungletv.ConsumeChatRequest
	44, // 43: jungletv.JungleTV.SendChatMessage:input_type -> jungletv.SendChatMessageRequest
	30, // 44: jungletv.JungleTV.ForciblyEnqueueTicket:input_type -> jungletv.ForciblyEnqueueTicketRequest
	28, // 45: jungletv.JungleTV.RemoveQueueEntry:input_type -> jungletv.RemoveQueueEntryRequest
	46, // 46: jungletv.JungleTV.RemoveChatMessage:input_type -> jungletv.RemoveChatMessageRequest
	48, // 47: jungletv.JungleTV.SetChatSettings:input_type -> jungletv.SetChatSettingsRequest
	5,  // 48: jungletv.JungleTV.SignIn:output_type -> jungletv.SignInProgress
	13, // 49: jungletv.JungleTV.EnqueueMedia:output_type -> jungletv.EnqueueMediaResponse
	15, // 50: jungletv.JungleTV.MonitorTicket:output_type -> jungletv.EnqueueMediaTicket
	20, // 51: jungletv.JungleTV.ConsumeMedia:output_type -> jungletv.MediaConsumptionCheckpoint
	22, // 52: jungletv.JungleTV.MonitorQueue:output_type -> jungletv.Queue
	27, // 53: jungletv.JungleTV.RewardInfo:output_type -> jungletv.RewardInfoResponse
	33, // 54: jungletv.JungleTV.SubmitActivityChallenge:output_type -> jungletv.SubmitActivityChallengeResponse
	35, // 55: jungletv.JungleTV.ConsumeChat:output_type -> jungletv.ChatUpdate
	45, // 56: jungletv.JungleTV.SendChatMessage:output_type -> jungletv.SendChatMessageResponse
	31, // 57: jungletv.JungleTV.ForciblyEnqueueTicket:output_type -> jungletv.ForciblyEnqueueTicketResponse
	29, // 58: jungletv.JungleTV.RemoveQueueEntry:output_type -> jungletv.RemoveQueueEntryResponse
	47, // 59: jungletv.JungleTV.RemoveChatMessage:output_type -> jungletv.RemoveChatMessageResponse
	49, // 60: jungletv.JungleTV.SetChatSettings:output_type -> jungletv.SetChatSettingsResponse
