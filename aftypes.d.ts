...
declare module "jungletv:configuration" {
    /** Represents the interface of the native JungleTV configuration module */
    interface Configuration {
         ...
         */
        setAppName(name?: string): boolean;
         ...
         * @returns true in circumstances where the AF runtime is working as expected.
         */
        setAppLogo(filename?: string): boolean;
         ...
         * @returns true in circumstances where the AF runtime is working as expected.
         */
        setAppFavicon(filename?: string): boolean;
         ...
         * @returns true in circumstances where the AF runtime is working as expected.
         */
        setSidebarTab(pageID?: string, beforeTabID?: string);
